...
Permission is granted to any individual to download, view, and run this
software for personal, internal use only.

The following actions are strictly prohibited:

1. Redistribution of the software or any part of it, in source or compiled form.
2. Modification of the source code.
3. Incorporation of any part of this software into other software, products,
   libraries, or services.
4. Commercial use, including selling, sublicensing, hosting, or offering the
   software as a service.
5. Publishing the software or any derivative works publicly.
